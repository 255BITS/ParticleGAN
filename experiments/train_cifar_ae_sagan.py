#!/usr/bin/env python
"""SAGAN-style spatial attention in the wider deconv G and trainable pixel D.

Standalone adaptation preserves the existing AE-GAN losses, GroupNorm and frozen
ResNet feature branch. Attention acts from step zero with unit residual weight;
there is no gate, output zero initialization, spectral norm or attention ramp.
"""
import argparse
import copy
import hashlib
