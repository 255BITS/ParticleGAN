#!/usr/bin/env python
"""Checkpoint particle-count scaling to up to 32768 centers.
...
def validate(cfg):
    if type(cfg['expansion_factor']) is not int or cfg['expansion_factor'] not in (1, 4, 8, 16, 32):
        raise ValueError('expansion_factor must be 1, 4, 8, 16 or 32')
