...
from .shared_ensemble_research import ARCHITECTURES, constructor, variant
...
def render(records, output):
    ...
    rows = ['# Shared cap6 smooth ensemble discriminator research', '',
...
def run(declaration, output):
    ...
    protocol.update(version='shared-ensemble-v1', declaration=declaration, seed=0, jobs=jobs,
