...
## Variant: target_anneal = delayed

| arm | coeff | n | final W1 (exact) | W2 (exact) | mode recall | modes | hq | per-mode σ ratio | NLL | collapse rate (mean ev) | steps→thresh | dom. modulus (max) | W1 win-std | dloss FFT pk | med_nr / med_nf @mid | wall (s) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| b_cap | 1 | 5 | 0.3671 ± 0.0283 | 0.6521 ± 0.0267 | 0.980 ± 0.006 | 100.0 | 0.955 | 2.852 ± 0.459 | 24.519 ± 7.463 | 0.00 (0.00) | >7000 ± 0 (5 censored) | 1.000 ± 0.000 (max 1.001) | 0.0008 | 3.853 | 0.675 / 0.822 | 104 |
| c_eikonal | 0.1 | 5 | 0.4488 ± 0.0662 | 0.7534 ± 0.0615 | 0.952 ± 0.026 | 100.0 | 0.942 | 4.916 ± 0.460 | 70.305 ± 14.928 | 0.00 (0.00) | >7000 ± 0 (5 censored) | 1.001 ± 0.001 (max 1.003) | 0.0006 | 6.109 | 1.037 / 1.201 | 122 |

## Variant: target_anneal = linear

| arm | coeff | n | final W1 (exact) | W2 (exact) | mode recall | modes | hq | per-mode σ ratio | NLL | collapse rate (mean ev) | steps→thresh | dom. modulus (max) | W1 win-std | dloss FFT pk | med_nr / med_nf @mid | wall (s) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| b_cap | 1 | 5 | 0.3453 ± 0.0360 | 0.6166 ± 0.0399 | 0.990 ± 0.006 | 100.0 | 0.929 | 2.472 ± 0.232 | 12.910 ± 2.265 | 0.00 (0.00) | >7000 ± 0 (5 censored) | 1.000 ± 0.000 (max 1.001) | 0.0009 | 1.744 | 0.495 / 0.602 | 106 |
| c_eikonal | 0.1 | 5 | 0.4398 ± 0.0746 | 0.7210 ± 0.0610 | 0.948 ± 0.020 | 100.0 | 0.936 | 3.567 ± 0.460 | 39.951 ± 11.565 | 0.00 (0.00) | >7000 ± 0 (5 censored) | 1.000 ± 0.000 (max 1.000) | 0.0004 | 3.321 | 0.762 / 0.942 | 119 |

## Variant: penalty norm = l1

| arm | coeff | n | final W1 (exact) | W2 (exact) | mode recall | modes | hq | per-mode σ ratio | NLL | collapse rate (mean ev) | steps→thresh | dom. modulus (max) | W1 win-std | dloss FFT pk | med_nr / med_nf @mid | wall (s) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| b_cap | 1 | 5 | 0.3312 ± 0.0444 | 0.6208 ± 0.0454 | 0.992 ± 0.007 | 100.0 | 0.978 | 2.579 ± 0.220 | 20.355 ± 1.620 | 0.00 (0.00) | >7000 ± 0 (5 censored) | 1.001 ± 0.000 (max 1.001) | 0.0004 | 46.026 | 0.503 / 0.675 | 120 |

## Variant: penalty norm = l1, lr_mult = 2.0

| arm | coeff | n | final W1 (exact) | W2 (exact) | mode recall | modes | hq | per-mode σ ratio | NLL | collapse rate (mean ev) | steps→thresh | dom. modulus (max) | W1 win-std | dloss FFT pk | med_nr / med_nf @mid | wall (s) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| b_cap | 1 | 5 | 0.3064 ± 0.0659 | 0.5800 ± 0.0611 | 0.992 ± 0.012 | 100.0 | 0.992 | 2.143 ± 0.245 | 9.433 ± 2.926 | 0.00 (0.00) | >7000 ± 0 (5 censored) | 1.001 ± 0.000 (max 1.002) | 0.0006 | 307.076 | 0.672 / 0.804 | 114 |

## Variant: penalty norm = linf

| arm | coeff | n | final W1 (exact) | W2 (exact) | mode recall | modes | hq | per-mode σ ratio | NLL | collapse rate (mean ev) | steps→thresh | dom. modulus (max) | W1 win-std | dloss FFT pk | med_nr / med_nf @mid | wall (s) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| b_cap | 1 | 5 | 0.3888 ± 0.0224 | 0.6768 ± 0.0129 | 0.968 ± 0.020 | 100.0 | 0.967 | 3.086 ± 0.181 | 33.217 ± 3.239 | 0.00 (0.00) | >7000 ± 0 (5 censored) | 1.001 ± 0.000 (max 1.001) | 0.0004 | 72.480 | 0.781 / 0.947 | 121 |

## Variant: penalty norm = linf, lr_mult = 2.0

| arm | coeff | n | final W1 (exact) | W2 (exact) | mode recall | modes | hq | per-mode σ ratio | NLL | collapse rate (mean ev) | steps→thresh | dom. modulus (max) | W1 win-std | dloss FFT pk | med_nr / med_nf @mid | wall (s) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| b_cap | 1 | 5 | 0.3252 ± 0.0275 | 0.6129 ± 0.0258 | 0.988 ± 0.004 | 100.0 | 0.990 | 2.419 ± 0.341 | 13.562 ± 3.431 | 0.00 (0.00) | >7000 ± 0 (5 censored) | 1.001 ± 0.000 (max 1.002) | 0.0006 | 595.287 | 1.122 / 1.290 | 124 |

## Variant: optimizer = oadam (optimistic Adam)

| arm | coeff | n | final W1 (exact) | W2 (exact) | mode recall | modes | hq | per-mode σ ratio | NLL | collapse rate (mean ev) | steps→thresh | dom. modulus (max) | W1 win-std | dloss FFT pk | med_nr / med_nf @mid | wall (s) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| a_r1r2 | 1 | 5 | 0.2031 ± 0.0265 | 0.3988 ± 0.0342 | 1.000 ± 0.000 | 100.0 | 0.609 | 4.282 ± 0.133 | 22.216 ± 1.535 | 0.00 (0.00) | >6840 ± 320 (4 censored) | 1.000 ± 0.000 (max 1.000) | 0.0004 | 0.420 | 0.049 / 0.087 | 108 |
| a_r1r2 | 0.1 | 5 | 0.2971 ± 0.0302 | 0.5741 ± 0.0310 | 0.996 ± 0.005 | 100.0 | 0.889 | 4.276 ± 0.650 | 40.645 ± 14.155 | 0.00 (0.00) | >7000 ± 0 (5 censored) | 1.000 ± 0.000 (max 1.000) | 0.0003 | 13.908 | 0.248 / 0.503 | 109 |
...
| c_eikonal | 1 | 5 | 0.1955 ± 0.0366 | 0.4359 ± 0.0457 | 0.998 ± 0.004 | 100.0 | 0.946 | 2.344 ± 0.264 | 12.736 ± 1.632 | 0.00 (0.00) | >6420 ± 744 (3 censored) | 1.005 ± 0.004 (max 1.012) | 0.0007 | 648.173 | 1.034 / 1.046 | 100 |
| c_eikonal | 0.1 | 5 | 0.1771 ± 0.0225 | 0.4009 ± 0.0379 | 1.000 ± 0.000 | 100.0 | 0.938 | 2.050 ± 0.483 | 8.216 ± 4.403 | 0.00 (0.00) | >6100 ± 1138 (3 censored) | 1.007 ± 0.003 (max 1.013) | 0.0008 | 6052.967 | 1.263 / 2.100 | 99 |
