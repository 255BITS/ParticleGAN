...
**Not the default.** The default particle recipe is YuE2 paired-error RpGAN
(`adv_weight=1`). This directory explains why the #16 teacher-forced gate
lied. The writeup is [docs/native16-autopsy.md](../../../docs/native16-autopsy.md).
