...
lines+=['', 'All numerical sources, episode bytes, original targets/gates and complete observation schedules were audited. Source implementation is unchanged `SmoothFourierCritic`; static initialization/output/input-gradient/cap-penalty/parameter-gradient equality was checked against the earlier implementation. Architecture support across cases must be labeled separately from a single shared discriminator.',
