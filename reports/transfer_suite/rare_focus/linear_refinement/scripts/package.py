...
SRC=Path('/tmp/pr36-valid-linear-final');DST=Path('/tmp/pr36-valid-linear-final-handoff');REPO=Path('/ml2/hypergan/ParticleGAN-pr36-valid-recipe')
...
README='''# Final linear-bypass handoff
...
(DST/'inventory.json').write_text(json.dumps({'episodes':9,'live_observations':216,'source_commit_base':'981ccbcd6e7e77a1f41f8aac3cc42d1fa1ceab45','files':items},indent=2,sort_keys=True)+'\n');print(DST)
