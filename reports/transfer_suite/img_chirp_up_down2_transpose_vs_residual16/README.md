# img_chirp_up_down2 — published transpose12 FAIL / residual16 PASS
...
CUDA_VISIBLE_DEVICES= PYTHONPATH=. python -u reports/transfer_suite/img_chirp_up_down2_transpose_vs_residual16/reproduce_arms.py
```
