...
out_png = root / "kite_wide_scatter.png"
means = np.array([[0.0, 16.0], [-10.0, 0.0], [10.0, 0.0], [0.0, -5.0]], dtype=np.float64)
...
fig.suptitle(f"kite_wide_h16 @ tip 510e005 — local sigma=1.0 ({note})")
fig.tight_layout()
