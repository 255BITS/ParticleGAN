...
out_png = root / "tall_spike_wide_scatter.png"
means = np.array([[-6.0, 0.0], [6.0, 0.0], [0.0, 16.0]], dtype=np.float64)
...
fig.suptitle(f"tall_spike_wide_h16 @ tip 510e005 — local sigma=1.0, h=16 base=12 ({note})")
fig.tight_layout()
