"""Apply the predeclared round11 gates, only after all five scouts finish."""
import json
from pathlib import Path

queue = Path('runs/memory_path/gru_round11')
report = Path('reports/memory-handoff/gru_round11')
