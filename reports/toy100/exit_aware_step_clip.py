...
def exit_aware_candidate(*, task="mode_hold", start_step=0):
    ...
    # The fence reads the real batch from mode_hold.sample_ring. Trajectory
    # has no ring sampler; the clip then has no reals and does not fire.
    # The mode-hold patch is the published one.
