...
lines.insert(2, '**Active work:** [port the original CPU winner to GPU](../cpu-recipe-gpu-port/README.md). This continuous-learning cohort remains historical evidence.\n')
