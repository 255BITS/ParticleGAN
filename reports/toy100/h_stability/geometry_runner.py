"""Selected-base particle geometry screens with the existing frozen runner.
...
critic_signal.signal_policy = geometry_policy
...
def sources():
    ...
    for path in (Path(__file__), Path(__file__).with_name("particle_geometry.py")):
