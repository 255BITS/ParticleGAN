Continue the ParticleGAN stable-GAN search from g_threequarter_rate, the current
...
The selected base passes cold ring but fails two_pole. Its OWN acquired state
passes83 dense continuation checks, then fails at1284/HQ.76123. Its earlier
200/200 result used borrowed H state and is not the current stability baseline.
Current fixed G/D/prior rates are .001125/.0015/.00225. H remains a comparator.
...
An explicit cheap diagnostic may locate a blocker; it is not promotion.
...
The auxiliary AE/unused-token structural blockers are already documented. Do
