...
def main() -> None:
    ...
    declaration = dict(seed=0, host="mode_hold", steps=1200, warm_prefix=1000,
                       ...
                       cold_arms=["scheduled_cold", "constant_cold", "adaptive_cold"],
    ...
    summary = dict(identity_parity=True,
                   ...
                   cold_candidate=dict(terminal=cold["terminal"],
                                       ...
                                       label=("COLD_DIAGNOSTIC_AFTER_WARM_FAIL"
                                              if not warm["adaptive"]["local_stability"]["pass_all"]
                                              else "COLD_MODE_HOLD_SCREEN")),
