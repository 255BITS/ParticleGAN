...
def main():
    ...
    for task in declaration['task_order']:
        ...
        try:
            ...
            with alternating_curvature(task=task,curvature_bound=args.curvature_bound,center_critic=args.center_critic,smooth_critic=args.smooth_critic,smooth_cap=args.smooth_cap,**extra) as (recorder,source):
