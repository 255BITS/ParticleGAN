...
from reports.toy100.sample_anchor_candidate import METHOD, sample_anchor_candidate

SOURCES=('reports/toy100/sample_anchor_state_filter.py',
...
def main():
    ...
    def selected(*,task,prediction):
        with sample_anchor_candidate(task=task,correction=prediction) as value:
            yield value
