...
from reports.toy100.sample_anchor_rest_candidate import METHOD, sample_anchor_rest_candidate

SOURCES=('reports/toy100/sample_anchor_rest_filter.py','reports/toy100/sample_anchor_rest_candidate.py',
    'reports/toy100/sample_anchor_candidate.py','reports/toy100/sample_group_anchor.py',
