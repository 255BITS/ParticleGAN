...
| Public v3 installed-wheel control | 19/19 | PASS |
...
| canonical | `two_pole` | PASS | noise applied True; eval learned_particles_and_critic_gradient; final suffix 12 |
| canonical | `trajectory` | PASS | noise applied True; eval generated_samples; final suffix 12 |
| canonical | `residual_student` | PASS | noise applied True; eval generated_samples; final suffix 11 |
...
| canonical | `cover_leftover` | PASS | noise applied True; eval learned_residual_parameters; final suffix 13 |
| canonical | `unused_token_hold` | PASS | noise applied True; eval learned_embedding_parameters; final suffix 6 |
...
| canonical | `vector_two_broad` | PASS | noise applied True; eval generated samples; final suffix 21 |
| canonical | `vector_unequal_mass` | PASS | noise applied True; eval generated samples; final suffix 5 |
| canonical | `vector_unequal_width` | PASS | noise applied True; eval generated samples; final suffix 17 |
| canonical | `vector_anisotropic` | PASS | noise applied True; eval generated samples; final suffix 20 |
| canonical | `vector_overlap` | PASS | noise applied True; eval generated samples; final suffix 12 |
| canonical | `vector_spiral` | PASS | noise applied True; eval generated samples; final suffix 12 |
| canonical | `img_stripes2` | PASS | noise applied True; eval generated samples; final suffix 13 |
| canonical | `img_bars4` | PASS | noise applied True; eval generated samples; final suffix 19 |
| canonical | `img_blobs4` | PASS | noise applied True; eval generated samples; final suffix 14 |
| canonical | `img_intensity2` | PASS | noise applied True; eval generated samples; final suffix 10 |
