...
def main():
    ...
    expected = {(r['name'], task) for r in rows for task in protocol['toys']}
        ...
        for row in rows:
            for task in protocol['toys']:
                ...
                if row['kind'] == 'reference':
                    assert dynamics['policy'] == 'original_public_recipe'
