...
| API-RP2: precision controller with explicit library-owned initialization | 640 | 177/177 | 500 | 171/171 | Public-constructor single-shift pass; own longer and checkpoint evidence pending. |
...
That distinct proposal must still earn its own longer and broader results.

## Ongoing work

The three lanes remain active. They preserve failed versions, explain a proposed
repair, and test that repair before broad qualification. A survivor still needs
